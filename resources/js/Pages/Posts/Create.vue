...
<template>
    <Head>
        <title>Create</title>
        <meta head-key="description" name="description" content="This is post create page">
    </Head>
    
    <div class="p-8 rounded-lg max-w-7xl mx-auto bg-gray-800">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-bold text-white">Add New Post</h2>
            <Link 
            ...
            <div class="mb-6">
                ...
                <div class="flex">
                    <div class="flex items-center me-4">
                        <input checked id="draft" type="radio" value="draft" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="draft" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Draft</label>
                    </div>
                    <div class="flex items-center me-4">
                        <input id="published" type="radio" value="published" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="published" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Published</label>
                    </div>
                    <div class="flex items-center me-4">
                        <input id="archived" type="radio" value="archived" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
