...
const signOut = () => {
    router.post(route('logout'), {}, {
        onBefore: () => confirm('Are you sure you want to log out?'),
    })
}
</script>
                        ...
                        <div class="flex items-center ms-3">
                            ...
                            <div class="z-50 hidden my-4 text-base list-none divide-y rounded-sm shadow-sm bg-gray-700 divide-gray-600"
                                ...
                                <ul class="py-1" role="none">
                                    ...
                                    <li>
                                        <button @click="signOut" type="button" class="block w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-gray-600 hover:text-white">
                                            Sign out
                                        </button>
                                    </li>
                                </ul>
